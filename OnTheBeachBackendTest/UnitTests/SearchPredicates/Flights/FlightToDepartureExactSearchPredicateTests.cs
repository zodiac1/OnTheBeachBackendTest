...
{
    public class FlightToDepartureExactSearchPredicateTests
    {
        ...
        public void IsMatch_TestFlight_ReturnsTrue()
        {
            ...
            var flightPredicate = new FlightToDepartureExactSearchPredicate { DepartureDate = testFlight.DepartureDate, To = testFlight.To };
